  ...
  <section class="w-full"> 
    ...
    <div class="w-2/3 m-auto flex flex-wrap justify-evenly items-center">
      <div class="w-96 px-3 pt-24 py-3 text-center border border-gray-900 relative my-10">
          ...
          <span>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro harum est inventore ex architecto! Eos iure ullam, possimus facere reprehenderit atque aperiam eligendi.
          </span>
      </div>
